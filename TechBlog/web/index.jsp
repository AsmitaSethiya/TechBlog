<%-- 
    Document   : index
    Created on : 12 Jun, 2023, 1:24:17 PM
       ...
       <!--navbar-->
        ...
        <div class="container-fluid p-0 m-0">
            <div class="jumbotron primary-background text-white banner-background">
                <div class="container">
                    <h3 class="display-3">Weclome to Techblog</h3>
                    ...
                    <button class="btn btn-outline-light btn-lg"><span class="fa fa-lightbulb-o"></span>Start ! it's free</button>
                    <a href="login_page.jsp" class="btn btn-outline-light btn-lg"><span class="fa fa-id-badge fa-spin"></span>Login</a>
                </div>
            </div>    
        </div>
